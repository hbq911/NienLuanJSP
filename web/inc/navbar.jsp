        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                ...
                <a href="#" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="assets/images/logo-sm.svg" alt="" height="26"> <span class="logo-txt">QFood</span>
                    </span>
                </a>
            </div>
                    ...
                    <div class="collapse navbar-collapse" id="topnav-menu-content">
                        <ul class="navbar-nav">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="hienthigiohang" id="topnav-pages" role="button">
                                    <i class="bx bx-customize icon"></i>
                                    <span data-key="t-apps">Giỏ Hàng</span> 
                                    <i>(${cart.size()})</i>
                                </a>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-components" role="button"
                                   >
                                    ...
                                    <span data-key="t-components">Thanh Toán</span> <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-components">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-form">
                                            <a href="#" class="dropdown-item" data-key="t-basic-elements">Basic Elements</a>
                                            <a href="#" class="dropdown-item" data-key="t-validation">Validation</a>
                                            <a href="#" class="dropdown-item" data-key="t-advanced-plugins">Advanced Plugins</a>
                                            <a href="#" class="dropdown-item" data-key="t-editors">Editors</a>
                                            <a href="#" class="dropdown-item" data-key="t-file-upload">File Upload</a>
                                            <a href="#" class="dropdown-item" data-key="t-wizard">Wizard</a>
                                            <a href="#" class="dropdown-item" data-key="t-mask">Mask</a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-table">
                                            <a href="#" class="dropdown-item" data-key="t-bootstrap-basic">Bootstrap Basic</a>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-charts">
                                            <a href="#" class="dropdown-item" data-key="t-line">Line</a>
                                            <a href="#" class="dropdown-item" data-key="t-area">Area</a>
                                            <a href="#" class="dropdown-item" data-key="t-column">Column</a>
                                            <a href="#" class="dropdown-item" data-key="t-bar">Bar</a>
                                            <a href="#" class="dropdown-item" data-key="t-mixed">Mixed</a>
                                            <a href="#" class="dropdown-item" data-key="t-timeline">Timeline</a>
                                            <a href="#" class="dropdown-item" data-key="t-candlestick">Candlestick</a>
                                            <a href="#" class="dropdown-item" data-key="t-boxplot">Boxplot</a>
                                            <a href="#" class="dropdown-item" data-key="t-bubble">Bubble</a>
                                            <a href="#" class="dropdown-item" data-key="t-scatter">Scatter</a>
                                            <a href="#" class="dropdown-item" data-key="t-heatmap">Heatmap</a>
                                            <a href="#" class="dropdown-item" data-key="t-treemap">Treemap</a>
                                            <a href="#" class="dropdown-item" data-key="t-pie">Pie</a>
                                            <a href="#" class="dropdown-item" data-key="t-radialbar">Radialbar</a>
                                            <a href="#" class="dropdown-item" data-key="t-radar">Radar</a>
                                            <a href="#" class="dropdown-item" data-key="t-polararea">Polararea</a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-icons">
                                            <a href="#" class="dropdown-item" data-key="t-unicons">Unicons</a>
                                            <a href="#" class="dropdown-item" data-key="t-feather-icons">Feather icons</a>
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle arrow-none" href="#" id="topnav-more" role="button"
                                   >
                                    ...
                                    <span data-key="t-pages">Lịch Sử Mua Hàng</span> <div class="arrow-down"></div>
                                </a>
                                <div class="dropdown-menu" aria-labelledby="topnav-more">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-pricing">
                                            <a href="#" class="dropdown-item" data-key="t-basic">Basic</a>
                                            <a href="#" class="dropdown-item" data-key="t-table">table</a>
                                        </div>
                                    </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-timeline">
                                            <a href="#" class="dropdown-item" data-key="t-center-view">Center View</a>
                                            <a href="#" class="dropdown-item" data-key="t-left-view">Left View</a>
                                        </div>
                                    </div>
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-auth">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-auth-basic">
                                                    <a href="#" class="dropdown-item" data-key="t-signin">Sign In</a>
                                                    <a href="#" class="dropdown-item" data-key="t-signup">Sign Up</a>
                                                    <a href="#" class="dropdown-item" data-key="t-signout">Sign Out</a>
                                                    <a href="#" class="dropdown-item" data-key="t-lock-screen">Lock Screen</a>
                                                    <a href="#" class="dropdown-item" data-key="t-forgot-password">Forgot Password</a>
                                                    <a href="#" class="dropdown-item" data-key="t-reset-password">Reset Password</a>
                                                    <a href="#" class="dropdown-item" data-key="t-email-verification">Email Verification</a>
                                                    <a href="#" class="dropdown-item" data-key="t-2step-verification">2-step Verification</a>
                                                    <a href="#" class="dropdown-item" data-key="t-thankyou">Thank you</a>
                                                </div>
                                            </div>
                                            <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-error">
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="topnav-404">
                                                    <a href="#" class="dropdown-item" data-key="t-basic">Basic</a>
                                                    <a href="#" class="dropdown-item" data-key="t-cover">Cover</a>
                                                </div>
                                            </div>
                                            <div class="dropdown">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="topnav-utility">
                                            ...
                                            <a href="#" class="dropdown-item" data-key="t-profile">Profile</a>
            ...
            <div class="dropdown d-inline-block language-switch">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="it">
                        <img src="assets/images/flags/covn.jpg" alt="user-image" class="me-2" height="12"> <span class="align-middle">VietNam</span>
                    </a>
                    <!-- item-->
            ...
            <div class="dropdown d-inline">
                <c:if test="${u==null}">
                    <button type="button" class="btn header-item user text-start d-flex align-items-center" id="page-header-user-dropdown"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span data-key="t-dashboard"><i class="bx bxs-user-check" style="font-size: 30px;"></i></span>
                    </button>
                ...
                <c:if test="${u!=null}">
                    <button type="button" class="btn header-item user text-start d-flex align-items-center" id="page-header-user-dropdown"
                            data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded-circle header-profile-user" src="imageUser?id=${u.id}"
                             alt="Header Avatar">
                        <span class="ms-2 d-none d-xl-inline-block user-item-desc">
                            <span class="user-name">${u.getName()}<i class="mdi mdi-chevron-down"></i></span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end pt-0"><c:set var="s" value="${u.getName()}"></c:set>
                        <h6 class="dropdown-header">Welcome <%
                            String name = (String) pageContext.getAttribute("s");
                            out.println(API.getName(name));
                            %></h6>
                        ...
                        <a class="dropdown-item" href="./view/logout.jsp"><i class="mdi mdi-logout text-muted font-size-16 align-middle me-1"></i> <span class="align-middle">Logout</span></a>
                    </div>
                </c:if>
            </div>
        </div>
