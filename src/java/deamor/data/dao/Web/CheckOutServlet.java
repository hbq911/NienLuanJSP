...
public class CheckOutServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
            throws ServletException, IOException {
        request.setAttribute("title", "CheckOut Page");
...
private double calculateTotalAmount(List<Product> cart) {
    double total = 0;
    for (Product product : cart) {
        total += product.getPrice() * product.getQuantity();  // Tính tổng tiền cho mỗi sản phẩm trong giỏ hàng
    }
    return total;
}
